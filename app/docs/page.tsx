  ...
  },
  {
    ...
    content: {
      ...
      paragraphs: [
        ...
        "JavaScript and TypeScript execute live in a Node.js VM sandbox. Other languages run via the Judge0 API (remote execution) or local compilers when available.",
      ],
      languages: [
        { name: "JavaScript", version: "ES2024", status: "Live (VM)" },
        { name: "TypeScript", version: "5.x", status: "Live (VM)" },
        { name: "Python", version: "3.10", status: "Judge0 API" },
        { name: "C", version: "GCC 10.2", status: "Judge0 API" },
        { name: "C++", version: "GCC 10.2", status: "Judge0 API" },
        { name: "Java", version: "15", status: "Judge0 API" },
        { name: "Go", version: "1.16", status: "Judge0 API" },
        { name: "Rust", version: "1.68", status: "Judge0 API" },
        { name: "Ruby", version: "3.0", status: "Judge0 API" },
        { name: "Haskell", version: "9.4", status: "Judge0 API" },
