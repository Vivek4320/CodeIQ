      ...
      <div style={{ width: "90%", maxWidth: "520px", maxHeight: "80vh", backgroundColor: theme.panel, border: `1px solid ${theme.border}`, borderRadius: "16px", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }}>
        <div style={{ padding: "16px 20px", borderBottom: `1px solid ${theme.border}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{ width: "32px", height: "32px", borderRadius: "8px", backgroundColor: `${theme.accent}15`, display: "flex", alignItems: "center", justifyContent: "center" }}><FileCode size={16} style={{ color: theme.accent }} /></div>
            <div><div style={{ fontSize: "15px", fontWeight: 600, color: theme.text }}>Code Templates</div><div style={{ fontSize: "11px", color: theme.muted }}>{templates.length} snippets across {languages.length} languages</div></div>
          </div>
